...
const skills: Skill[] = [
  ...
  { name: "React", rating: 2.5, icon: <FaReact className="text-blue-500 text-3xl" /> },
  { name: "Node.js", rating: 2, icon: <FaNodeJs className="text-green-600 text-3xl" /> },
  { name: "React Native", rating: 2, icon: <FaReact className="text-blue-500 text-3xl" /> },
...
export const userData: UserProfile = {
  ...
  age: 23,
  profile: profileImg,
  linkedin: "https://www.linkedin.com/in/biniam-mulugeta",
  github: "https://github.com/BinaChapi",
  x:"https://twitter.com/BenjaChapo",
  phoneNo: "+251 799 11 1485",
  telegram: "https://t.me/bbenjab",
