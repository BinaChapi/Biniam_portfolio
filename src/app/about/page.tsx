        ...
        <div className="relative group">
          ...
          <div className="relative bg-white/50 backdrop-blur-lg rounded-3xl border border-white/10 p-8 shadow-lg overflow-hidden">
            ...
            <div className="space-y-4 text-gray-800">
              <p>
                I am a 24-year-old graduate with a Bachelor's degree in Computer Science and a deep passion for software development, especially in the fields of mobile and web application development
              </p>
              <p>
